...
// RIGHT_D: straight edge at x=829.8 replaced with subtle elliptical arc (80px deep).
// Enough to round the "U" bottom when rotated, not enough to create visible overlap in SS/DD.
const RIGHT_D = 'M829.8,1285 v-215.5 c0,-1.1,1.5,-1.3,1.8,-0.2,31.2,123.9,144.1,215.7,278.7,215.7 h287.3 v-570 h-287.3 c-134.6,0,-247.5,91.8,-278.7,215.7,-0.3,1,-1.8,0.8,-1.8,-0.2 v-215.5 A80,285,0,0,0,829.8,1285Z'
