...
// RIGHT_D includes a semicircular cap on the left edge (same curve as LEFT_D).
// In SS/DD this cap hides behind LEFT_D (same white fill = invisible overlap).
// When RIGHT_D rotates for UD, the cap provides smooth curve instead of harsh cut.
